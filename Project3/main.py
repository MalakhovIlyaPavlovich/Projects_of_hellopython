...
while True:
    if language.lower() == 'english' or language.lower() == 'en' or language == '1' or language == '1.' or language.lower() == '1. english':
        import local_en as loc
        break
    elif language.lower() == 'russian' or language.lower() == 'ru' or language == '2' or language == '2.' or language.lower() == '2. russian':
